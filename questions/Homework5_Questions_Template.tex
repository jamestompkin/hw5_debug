...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\pagebreak
\paragraph{Q4:} What effects are caused by adding a spatial max pooling layer (stride > 1) after a single convolutional layer, where the output with max pooling is some size larger than 1 x 1 x d?
